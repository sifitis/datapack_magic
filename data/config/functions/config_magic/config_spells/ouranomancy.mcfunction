...
execute if score bMTP_COST_ON_SET config_magic matches ..0 run tellraw @s {"text":"","color":"gray","extra":[{"text":"[EDIT]","color":"dark_gray","clickEvent":{"action":"run_command","value":"/scoreboard players set bMTP_COST_ON_SET config_magic 1"}},{"text":" ["},{"text":"FALSE","color":"red"},{"text":"] Charge XP when setting instead of using. "}]}
execute if score bMTP_COST_ON_SET config_magic matches 1.. run tellraw @s {"text":"","color":"gray","extra":[{"text":"[EDIT]","color":"dark_gray","clickEvent":{"action":"run_command","value":"/scoreboard players set bMTP_COST_ON_SET config_magic 0"}},{"text":" ["},{"text":"TRUE","color":"green"},{"text":"] Charge XP when setting instead of using. "}]}
