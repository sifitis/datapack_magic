...
# generates a scoreboard of unit vectors (scaled by 1000) from the caster to the targets

###################################################################################################
###############DO NOT USE FOR DISTANCES OVER 40 BLOCKS or far from the spawn!!!!!##################
###################################################################################################
...
execute as @e[tag=unit_target] store result score @s UX run data get entity @s Pos[0] 100
execute as @e[tag=unit_target] store result score @s UY run data get entity @s Pos[1] 100
execute as @e[tag=unit_target] store result score @s UZ run data get entity @s Pos[2] 100

execute as @e[tag=unit_caster] store result score CASTER UX run data get entity @s Pos[0] 100
execute as @e[tag=unit_caster] store result score CASTER UY run data get entity @s Pos[1] 100
execute as @e[tag=unit_caster] store result score CASTER UZ run data get entity @s Pos[2] 100
...
execute as @e[tag=unit_target] run scoreboard players operation @s UX *= CONST_10e2 m_constants
execute as @e[tag=unit_target] run scoreboard players operation @s UY *= CONST_10e2 m_constants
execute as @e[tag=unit_target] run scoreboard players operation @s UZ *= CONST_10e2 m_constants
